...
<%@ include file = "../member/member_head.jsp" %>
	<header>
	<h1 class="gms-h1">NO ID</h1>
	</header>
	<hr /><br />
		<div id="image" class="gms-image"><a href="<%=request.getContextPath()%>/index.jsp"><img src="<%=request.getContextPath()%>/resources/img/join.jpg" alt=""/></a></div><br />
